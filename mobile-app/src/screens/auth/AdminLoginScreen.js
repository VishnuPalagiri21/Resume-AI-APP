...
export const AdminLoginScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    const loadSaved = async () => {
      const creds = await getRoleCredentials('admin');
  ...
  const handleRemoveAccount = async (accEmail) => {
    await removeRoleCredential('admin', accEmail);
  ...
  const handleAdminLogin = async () => {
    ...
    try {
      ...
      if (rememberMe) {
        await saveRoleCredential('admin', email, password);
      }
    } catch (err) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      {/* ── Top Portal Strip (03 ── ADMIN PORTAL) ── */}
      <View style={styles.topHeaderBar}>
        <View style={styles.topHeaderContent}>
          <Text style={styles.portalNumber}>03</Text>
          <View style={styles.topHeaderLine} />
          <Text style={styles.portalLabelText}>ADMIN PORTAL</Text>
        </View>
      </View>
          ...
          <View style={styles.logoSection}>
            <View style={styles.logoRow}>
              ...
              <View>
                ...
                <Text style={styles.logoSubText}>SYSTEM ADMINISTRATION</Text>
              </View>
            </View>
            ...
            <View style={styles.pillBadgeContainer}>
              <View style={styles.pillBadge}>
                ...
                <Text style={styles.pillText}>ADMIN SIGN-IN</Text>
              </View>
            </View>
            ...
            <View style={styles.headingBox}>
              ...
              <Text style={styles.welcomeSubtitle}>
                Sign in to access platform administration controls.
              </Text>
            </View>
          </View>
