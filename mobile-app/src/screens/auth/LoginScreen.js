...
export const LoginScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    const loadSaved = async () => {
      const creds = await getRoleCredentials(role);
  ...
  const handleRemoveAccount = async (accEmail) => {
    await removeRoleCredential(role, accEmail);
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (rememberMe) {
        await saveRoleCredential(role, email, password);
      }
    } catch (err) {
      ...
      >
        ...
        >
          ...
          <View style={styles.logoSection}>
            ...
            {/* ── Portal Pill Sign-In Badge ── */}
            <View style={styles.pillBadgeContainer}>
              <View style={styles.pillBadge}>
                <View style={styles.pillDot} />
                <Text style={styles.pillText}>CANDIDATE SIGN-IN</Text>
              </View>
            </View>
          ...
          {/* ── PASSWORD Input with inline Forgot password? pill ── */}
          <View style={styles.inputGroup}>
          ...
          {/* ── Primary Sign In -> Button (Official Violet/Cyan) ── */}
          <TouchableOpacity
            style={[
              styles.signInButton,
